...
function rCli(page){
  ...
  if(_cliView==='table'){
    if(tf==='vendor'){
      ...
      }).join(''):'<tr><td colspan="7" class="empty-cell">거래처 없음</td></tr>';
    }
  }else{
