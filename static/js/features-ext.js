...
function rPerm(){
  ...
  var allMods=['mes-dash','qc-quote','mes-order','mes-wo','mes-plan','mes-proc-log','mes-outsource','mes-worker','mat-stock','mat-income','mat-po','mat-bom','mes-vendor','mes-ship','acc-sales','acc-purchase','acc-tax','acc-recv','acc-cashflow','mes-cli','mes-prod','mes-mold','qc-inspect','qc-equip','adm-perm','adm-backup','adm-audit','adm-code','mes-queue'];
  var modNames={'mes-dash':'패키지 운영판','qc-quote':'패키지 견적','mes-order':'수주관리','mes-wo':'패키지 작업지시','mes-plan':'생산계획','mes-proc-log':'공정실적','mes-outsource':'외주관리','mes-worker':'현장작업','mat-stock':'재고현황','mat-income':'원자재입고','mat-po':'구매발주','mat-bom':'BOM','mes-vendor':'협력사','mes-ship':'출고관리','acc-sales':'매출장부','acc-purchase':'매입장부','acc-tax':'세금계산서','acc-recv':'채권관리','acc-cashflow':'입출금','mes-cli':'거래처','mes-prod':'패키지 품목','mes-mold':'목형','qc-inspect':'품질검사','qc-equip':'설비관리','adm-perm':'권한관리','adm-backup':'백업/복원','adm-audit':'감사로그','adm-code':'공통코드','mes-queue':'시스템설정'};
