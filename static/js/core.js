...
(function(){
  ...
  var KEY_TO_MODULES = {
    'wo':         ['mes-wo','mes-plan','mes-dash','mes-ship','mes-proc-log','mes-rpt','mes-worker'],
    'hist':       ['mes-rpt','mes-proc-log','mes-perf','mes-dash'],
    'shipLog':    ['mes-ship','mes-shiplog','mes-dash'],
    'sales':      ['acc-sales','mes-dash'],
